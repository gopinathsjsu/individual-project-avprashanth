#Information to know - 
1) This is a java project built using Gradle 
...
10) Output.csv and Error.txt files will be generated for positive and failed cases respectively. These files can be located in project directory.
